...
PARAM$ranger <- list(
  "num.trees" = 498, #700, # cantidad de arboles
  "mtry" =13,  #15, # cantidad de atributos que participan en cada split
  "min.node.size" =300,  #50,#35,  #50, # tamaño minimo de las hojas
  "max.depth" =14  #12 # 0 significa profundidad infinita
)
...
# cargo los datos
dataset <- fread("./competencia_01_python.csv")
...
nom_arch_kaggle <- "KA4720_001_vBo2.csv"
